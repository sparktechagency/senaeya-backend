...
const getSubscriptionByIdToDB = async (subscriptionId: string) => {
     ...
     console.log('🚀 ~ getSubscriptionByIdToDB ~ subscription.subscription_qr_code:', subscription.subscription_qr_code);
     const qrCode = await generateQRFromObject(subscription);
     console.log('🚀 ~ getSubscriptionByIdToDB ~ qrCode:', qrCode);
