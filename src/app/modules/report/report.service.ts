...
const getAllReportsByCreatedDateRange = async (query: Record<string, any>, providerWorkShopId: string, user: any, access_token: string) => {
     ...
     const [
          ...
          // total of unpaid and non postpaid invoices finalCost
          Invoice.aggregate([
     ...
     const totalUnpaidFinalCost = totalAllUnpaindAmoutAgg[0]?.total || 0;
     ...
     console.log("totalUnpaidFinalCost 🪷💐💐❇️❇️:", totalUnpaidFinalCost);
     ...
     let report: {
          ...
          totalUnpaidFinalCost: income ? totalUnpaidFinalCost : undefined,
