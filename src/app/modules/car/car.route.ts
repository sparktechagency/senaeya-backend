...
router.get('/provider', auth(USER_ROLES.WORKSHOP_MEMBER, USER_ROLES.WORKSHOP_OWNER, USER_ROLES.SUPER_ADMIN), validateUserAuthority(), carController.getAllCarsWithOutProvider);
router.get('/provider-cars', auth(USER_ROLES.WORKSHOP_MEMBER, USER_ROLES.WORKSHOP_OWNER, USER_ROLES.SUPER_ADMIN), validateUserAuthority(), carController.getAllCarsWithProvider);
