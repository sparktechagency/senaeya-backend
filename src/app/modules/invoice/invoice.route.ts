...
router.post('/', auth(USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN),
    ...
    validateRequest(invoiceValidation.createInvoiceZodSchema), invoiceController.createInvoice);
...
router.patch('/:id', fileUploadHandler(),
    ...
    validateRequest(invoiceValidation.updateInvoiceZodSchema), invoiceController.updateInvoice);
